        ...
        <div className="bg-white dark:bg-slate-900">
          <div className="relative mx-auto w-full max-w-7xl overflow-hidden px-4 py-12 sm:px-6 sm:py-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-4 text-lg leading-6 text-slate-500"><span style={{color:"#fea614"}}>//</span> Let’s connect! </p>
            </div>

            <div className="mx-auto mt-10 max-w-xl">
              <ul>
                {contactLinks.map((link) => (
                  <li key={link.name} className="contact-list-container mb-3">
                    <a href={link.href} rel="noreferrer" target="_blank" className="contact-list-layout">
                      <svg className="h-12 w-12" viewBox={link.viewBox} xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                        <path d={link.icon} />
                      </svg>

                      <div className="ml-5">
                        <h3 className="text-lg font-semibold leading-8 text-slate-900">{link.name}</h3>
                        <p className="text-slate-900">{link.description}</p>
                      </div>
                    </a>
                  </li>
                ))}
