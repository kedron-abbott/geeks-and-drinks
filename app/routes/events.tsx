        ...
        <div className="relative mx-auto w-full max-w-7xl overflow-hidden px-4 py-12 sm:px-6 sm:py-6 lg:px-8">
          ...
          <ul className="mt-14 grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-2">
            {events.map((event: 
              ...
              <li key={event.id} className="event-card-container group relative flex flex-col overflow-hidden rounded-sm border border-gray-200 bg-white">
                ...
                <div className="flex flex-1 flex-col space-y-2 p-4">
                  ...
                  <div className="flex">
                    <div className="chip chip-yellow flex items-center">
                      ...
                      <p className="text-sm font-small">{new Date(event.start.local).toDateString()}</p>
                    </div>
                    <div className="chip chip-red flex">
                      <svg className="h-6 w-6" fill="currentColor" viewBox="0 -960 960 960">
                        <g>
                          <circle cx="128" cy="128" r="128"></circle>
                          <path
                      ...
                      <p className="text-sm font-small">{event.venue.name}</p>
                    </div>
                  </div>
                </div>
              </li>
