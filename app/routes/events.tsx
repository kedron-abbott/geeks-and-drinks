            ...
            <ul className="mt-14 grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-2">
              {events.map(
                (event: {
                  ...
                  <li
                    key={event.id}
                    className="event-card-container relative flex flex-col  justify-between overflow-hidden rounded-sm border border-gray-200 bg-white"
                  >
                    <div>
                      ...
                      <div className="p-4">
                        ...
                        <p className="mt-2 text-sm text-gray-500">{event.description.text}</p>
                      </div>
                    </div>
                    <div className="mb-2 flex items-center justify-between p-4">
                      <div className="flex">
                        <div className="chip chip-yellow flex items-center">
                          ...
                          <p className="ml-1 text-xs">{new Date(event.start.local).toDateString()}</p>
                        </div>
                        <div className="chip chip-yellow ml-1 flex items-center">
                          <a href={event.url} className="flex items-center">
                            ...
                            <p className="ml-1 text-xs">{event.venue.name}</p>
                          </a>
                        </div>
                      </div>
                      <div>
                        <a
                          href={event.url}
                          target="_blank"
                          className="bg-yellow-gd hover:bg-yellow-gd-hover mb-2 rounded-lg px-5 py-2.5 text-sm font-medium text-white focus:outline-none "
                        >
                          Register
                        </a>
                      </div>
